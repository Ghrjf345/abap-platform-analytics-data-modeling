...
define view entity ZANA_I_CARRHIERNODE_TD 
as select from Zana_cr_t_hn
  association to ZANA_I_CARRIERHIERDIR_TD as _Dir on  _Dir.HierarchyID = $projection.HierarchyID
