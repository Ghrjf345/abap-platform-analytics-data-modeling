/*
The difference of this query view to the query view ZANA_C_PAR_DERIVATION is, that the parameter
...
define transient view entity ZANA_C_PAR_DERIVATION_1
  provider contract analytical_query
  with parameters
    @AnalyticsDetails.variable.defaultValue: '20240909'
    P_FlightDate : Zflight_date,
    ...
    P_FirstDayOfMonth : Zflight_date
