...
define transient view entity ZANA_C_OLP_CURMEM_SNG
...
as projection on ZANA_I_FlightCube
  ...
  association [*] to ZANA_I_FlightCube as _previousMonth 
   ...
   association [*] to ZANA_I_FlightCube as _MonthPrevQuarter 
