...
CLASS lcl_airline_hier DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      get_instance IMPORTING i_hieid         TYPE Zana_carrier_hieid
  ...
  PRIVATE SECTION.
    CONSTANTS: c_nodename TYPE Zana_nodename VALUE 'ALLIANCE_'.
    TYPES:
      pt_t_carrier_hier      TYPE STANDARD TABLE OF Zana_cr_s_h,
      pt_s_carrier_hier      TYPE Zana_cr_s_h,
      pt_t_carrier_hier_dir  TYPE STANDARD TABLE OF Zana_cr_s_hd,
      pt_s_carrier_hier_dir  TYPE Zana_cr_s_hd,

      pt_t_carrier_hier_td      TYPE STANDARD TABLE OF Zana_cr_t_h,
      pt_s_carrier_hier_td      TYPE Zana_cr_t_h,
      pt_t_carrier_hier_td_node TYPE STANDARD TABLE OF Zana_cr_t_hn,
      pt_s_carrier_hier_td_node TYPE Zana_cr_t_hn,
      pt_t_carrier_hier_td_dir  TYPE STANDARD TABLE OF Zana_cr_t_hd,
      pt_s_carrier_hier_td_dir  TYPE Zana_cr_t_hd,

      BEGIN OF pt_s_nodeid,
        nodename TYPE Zana_nodename,
        datefrom TYPE Zana_date_from,
        dateto   TYPE Zana_date_to,
        node_id  TYPE Zana_carrier_nodeid,
      END OF pt_s_nodeid,
      BEGIN OF pt_s_parent,
        parent_id TYPE Zana_carrier_nodeid,
        datefrom  TYPE Zana_date_from,
        dateto    TYPE Zana_date_to,
      END OF pt_s_parent,
    ...
    DATA: p_min_date  TYPE d,
          ...
          p_i2_date   TYPE d,
          p_max_date  TYPE d,
          p_hieid     TYPE Zana_carrier_hieid,
          p_ts_curr   TYPE SORTED TABLE OF Zcurrency_code WITH UNIQUE KEY table_line,
    ...
    methods:
      get_parent_id IMPORTING i_s_carrier TYPE Zcarrier
